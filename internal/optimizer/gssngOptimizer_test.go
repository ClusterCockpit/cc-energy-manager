...
func TestInit(t *testing.T) {
	...
	_, err := NewGssNgOptimizer(json.RawMessage(testconfig))
	if err != nil {
		t.Errorf("failed to init GssNgOptimizer: %v", err.Error())
		return
	}
}
...
func TestUpperBarrier(t *testing.T) {
	...
	cclog.Init(loglevel, false)
	o, err := NewGssNgOptimizer(json.RawMessage(testconfig))
	if err != nil {
		t.Errorf("failed to init GssNgOptimizer: %v", err.Error())
		return
	}
...
func TestFirestarterBergamo(t *testing.T) {
	...
	o, err := NewGssNgOptimizer(json.RawMessage(testconfig))
	if err != nil {
		t.Fatalf("failed to init GssNgOptimizer: %v", err)
	}
